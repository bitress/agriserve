                        ...
                        <div class="w-100">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form method="POST" action="land_edit.php">

                                        <input type="hidden" name="land_id" value="<?= $_GET['id'] ?>">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-control" name="farm_owner" id="farm_owner">
                                                ...
                                                foreach ($farmers as $f):
                                                    $selected = ($f['farmer_id'] == $farmer_id) ? 'selected' : '';
                                                    ?>
                                                    <option value="<?= $f['farmer_id'] ?>" <?= $selected ?>><?= $f['firstname'] ?> <?= $f['middlename'] ?> <?= $f['surname'] ?> <?= $f['extension_name'] ?> </option>
                                                <?php endforeach; ?>
                                            </select>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <select class="form-control" name="ownership_type">
                                                    <?php
                                                    $ownership_types = [
                                                        "certificateOfLandTransfer" => "Certificate of Land Transfer",
                                                        "emancipationPatent" => "Emancipation Patent",
                                                        "individualCertificateOfLand" => "Individual Certificate of Land",
                                                        "collectiveCLOA" => "Collective CLOA",
                                                        "coownershipCLOA" => "Co-ownership CLOA",
                                                        "agriculturalSalesPatent" => "Agricultural Sales Patent",
                                                        "homesteadPatent" => "Homestead Patent",
                                                        "freePatent" => "Free Patent",
                                                        "certificateOfTitle" => "Certificate of Title or Regular Title",
                                                        "certificateOfAncestralDomainTitle" => "Certificate of Ancestral Domain Title",
                                                        "certificateOfAncestralLandTitle" => "Certificate of Ancestral Land Title",
                                                        "taxDeclaration" => "Tax Declaration",
                                                        "others" => "Others (e.g., Barangay Certification)"
                                                    ];


                                                    foreach ($ownership_types as $value => $label):
                                                        $selected = ($value == $ownership_type) ? 'selected' : '';
                                                        ?>
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <input type="text" class="form-control" placeholder="Land Area" name="land_area" value="<?= $land_area ?>">
                                            </div>
                                            <div class="col-md-3">
                                                <label>Land Location</label>
                                                <input type="text" class="form-control" placeholder="Land Location" name="land_location" value="<?= $location ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" class="form-control" name="ownership_document_number" id="ownership_document_number" value="<?= $ownership_document_number ?>">
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-check form-check-inline">
                                                    <input type="checkbox" class="form-check-input" name="agrarian_reform_beneficiary" <?= ($agrarian_reform_beneficiary == 1) ? 'checked' : '' ?>>
                                                    <label class="form-check-label">Agrarian Reform Beneficiary</label>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-check form-check-inline">
                                                    <input type="checkbox" class="form-check-input" name="within_ancestral_domain" <?= ($within_ancestral_domain == 1) ? 'checked' : '' ?>>
                                        ...
                                        <div class="mt-3">
                                            <button type="submit" name="edit_land" class="btn btn-primary">Save</button>
                                        </div>
                                    </form>
